...
- Commit `884fe96`; deploy GitHub Actions `success`. Terverifikasi live via browser di `https://app.clincoo.buzz/integrasi/`: heading dan pencarian memakai "Plugin", logo GitHub tampil langsung tanpa card pembungkus.
